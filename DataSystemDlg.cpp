...
BEGIN_MESSAGE_MAP(CDataSystemDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
END_MESSAGE_MAP()
...
// CDataSystemDlg 消息处理程序

BOOL CDataSystemDlg::OnInitDialog()
{
...
void CDataSystemDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CDataSystemDlg::OnQueryDragIcon()
{
